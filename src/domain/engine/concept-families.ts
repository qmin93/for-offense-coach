...
export const CONCEPT_FAMILIES: ConceptFamily[] = [
  ...
  // Outside Zone Family
  {
    ...
    baseConceptId: "concept_run_outside_zone",
    conceptType: "run",
    summary: "Stretch scheme attacking perimeter with cutback lanes",
    variations: [
      {
        conceptId: "concept_run_outside_zone",
        label: "Base OZ",
        description: "Standard outside zone stretch",
        tags: ["base"],
      },
      {
        conceptId: "concept_run_stretch",
        label: "Stretch",
        description: "Outside zone stretch to perimeter",
        tags: ["stretch", "perimeter"],
      },
      {
        conceptId: "concept_run_toss",
        label: "Toss",
        description: "Toss sweep to outside",
        tags: ["toss", "perimeter"],
      },
    ],
    alerts: [
  ...
  // Power Family
  {
    id: "family_power",
    name: "Power Family",
    baseConceptId: "concept_run_power",
    conceptType: "run",
    ...
    variations: [
      ...
      {
        conceptId: "concept_run_qb_power",
        label: "QB Power",
        description: "Power with QB as ball carrier",
        tags: ["qb_run", "gap"],
      },
      {
        conceptId: "concept_run_counter",
      ...
      {
        conceptId: "concept_run_trap",
        label: "Trap",
        description: "Trap block with pulling guard",
        tags: ["trap", "gap"],
      },
    ],
    alerts: [
  ...
  // Duo Family
  {
    id: "family_duo",
    name: "Duo Family",
    baseConceptId: "concept_run_duo",
    conceptType: "run",
    summary: "Double-team focused scheme with RB reading 1st level",
    variations: [
      {
        conceptId: "concept_run_duo",
        label: "Base Duo",
        description: "Standard duo with double teams",
        tags: ["base"],
      },
      {
        conceptId: "concept_run_iso",
        label: "Iso",
        description: "Isolation play with FB lead block",
        tags: ["iso", "downhill"],
      },
      {
        conceptId: "concept_run_wham",
        label: "Wham",
        description: "Wham block from TE/H back",
        tags: ["wham", "misdirection"],
      },
    ],
    alerts: [
      {
  ...
  // Smash Family
  {
    id: "family_smash",
    name: "Smash Family",
    baseConceptId: "concept_pass_smash",
    conceptType: "pass",
    summary: "Corner/Hitch combination attacking CB leverage",
    variations: [
      {
        conceptId: "concept_pass_smash",
        label: "Smash",
        description: "Corner + Hitch combo",
        tags: ["base", "cover2_beater"],
      },
      {
        conceptId: "concept_pass_levels",
        label: "Levels",
        description: "3-level zone stretch",
        tags: ["levels", "high_low"],
      },
      {
        conceptId: "concept_pass_curl_flat",
        label: "Curl/Flat",
        description: "Curl + Flat high/low combo",
        tags: ["curl", "flat"],
      },
    ],
    alerts: [
  ...
  // Four Verts Family
  {
    ...
    baseConceptId: "concept_pass_verts",
    conceptType: "pass",
    summary: "Four vertical routes stressing deep coverage",
    variations: [
      {
        conceptId: "concept_pass_verts",
        label: "4 Verts",
        description: "All four eligibles run vertical",
        tags: ["base", "explosive"],
      },
      {
        conceptId: "concept_pass_hitch_seam",
        label: "Hitch/Seam",
        description: "Seam stress with underneath hitch",
        tags: ["seam", "read"],
      },
      {
        conceptId: "concept_pass_switch_verts",
        label: "Switch Verts",
        description: "Leverage confusion with switch releases",
        tags: ["switch", "adjustment"],
      },
    ],
    alerts: [
      {
  ...
  // Slant/Flat Family
  {
    ...
    baseConceptId: "concept_pass_slant_flat",
    conceptType: "pass",
    summary: "Quick game slant with flat route combination",
    variations: [
      {
        conceptId: "concept_pass_slant_flat",
        label: "Slant/Flat",
        description: "Slant + Flat quick combo",
        tags: ["base", "quick"],
      },
      {
        conceptId: "concept_pass_stick",
        label: "Stick",
        description: "Hitch + Flat defender conflict",
        tags: ["stick", "quick"],
      },
      {
        conceptId: "concept_pass_wr_screen",
        label: "WR Screen",
        description: "Quick screen to WR",
        tags: ["screen", "quick"],
      },
    ],
    alerts: [
